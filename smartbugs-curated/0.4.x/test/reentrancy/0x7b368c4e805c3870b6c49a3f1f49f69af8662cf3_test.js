...
describe("Reentrancy Attack for 0x7b368c4e805c3870b6c49a3f1f49f69af8662cf3.sol", function () {
  ...
  beforeEach(async function () {
    ...
    const logPath = path.join(
      __dirname,
      "../../artifacts/contracts/dataset/reentrancy/0x7b368c4e805c3870b6c49a3f1f49f69af8662cf3.sol/Log.json",
    );
    ...
    const codePath = path.join(
      __dirname,
      "../../artifacts/contracts/dataset/reentrancy/0x7b368c4e805c3870b6c49a3f1f49f69af8662cf3.sol/W_WALLET.json",
    );
    ...
    MaliciousContract = await ethers.getContractFactory(
      "contracts/reentrancy/0x7b368c4e805c3870b6c49a3f1f49f69af8662cf3_attack.sol:MaliciousContract",
    );
    hacker = await MaliciousContract.deploy(victim.target);
  });

  it("functional check: reentrancy/0x7b368c4e805c3870b6c49a3f1f49f69af8662cf3.sol", async function () {
