...
describe("Reentrancy Attack for 0x93c32845fae42c83a70e5f06214c8433665c2ab5.sol", function () {
  ...
  beforeEach(async function () {
    ...
    const logPath = path.join(
      __dirname,
      "../../artifacts/contracts/dataset/reentrancy/0x93c32845fae42c83a70e5f06214c8433665c2ab5.sol/Log.json",
    );
    ...
    const codePath = path.join(
      __dirname,
      "../../artifacts/contracts/dataset/reentrancy/0x93c32845fae42c83a70e5f06214c8433665c2ab5.sol/X_WALLET.json",
    );
    ...
    MaliciousContract = await ethers.getContractFactory(
      "contracts/reentrancy/0x93c32845fae42c83a70e5f06214c8433665c2ab5_attack.sol:MaliciousContract",
    );
    hacker = await MaliciousContract.deploy(victim.target);
  });

  it("functional check: reentrancy/0x93c32845fae42c83a70e5f06214c8433665c2ab5.sol", async function () {
