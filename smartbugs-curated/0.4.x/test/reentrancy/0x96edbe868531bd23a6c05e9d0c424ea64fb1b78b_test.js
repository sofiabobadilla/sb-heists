...
describe("Reentrancy Attack for 0x96edbe868531bd23a6c05e9d0c424ea64fb1b78b.sol", function () {
  ...
  beforeEach(async function () {
    ...
    const logPath = path.join(
      __dirname,
      "../../artifacts/contracts/dataset/reentrancy/0x96edbe868531bd23a6c05e9d0c424ea64fb1b78b.sol/LogFile.json",
    );
    ...
    const codePath = path.join(
      __dirname,
      "../../artifacts/contracts/dataset/reentrancy/0x96edbe868531bd23a6c05e9d0c424ea64fb1b78b.sol/PENNY_BY_PENNY.json",
    );
    ...
    MaliciousContract = await ethers.getContractFactory(
      "contracts/reentrancy/0x96edbe868531bd23a6c05e9d0c424ea64fb1b78b_attack.sol:MaliciousContract",
    );
    hacker = await MaliciousContract.deploy(victim.target);
  });

  it("functional check: reentrancy/0x96edbe868531bd23a6c05e9d0c424ea64fb1b78b.sol", async function () {
