...
describe("attack unchecked_low_level_calls/0xe894d54dca59cb53fe9cbc5155093605c7068220.sol", function () {
  ...
  async function deployContracts() {
    ...
    const codePath = path.join(
      __dirname,
      "../../artifacts/contracts/dataset/unchecked_low_level_calls/0xe894d54dca59cb53fe9cbc5155093605c7068220.sol/airDrop.json",
    );
  ...
  it("functional check: unchecked_low_level_calls/0xe894d54dca59cb53fe9cbc5155093605c7068220.sol", async function () {
  ...
  it("exploit unchecked low level call vulnerability", async function () {
    ...
    await expect(contract.transfer(from, token.target, to, val, dec)).not.be
      .reverted;
